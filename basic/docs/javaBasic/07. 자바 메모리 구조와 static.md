...
> 내가 작성한 [`memory`](../../java-basic/src/memory), [`static1`](../../java-basic/src/static1),
> [`static2`](../../java-basic/src/static2) 패키지
>
> 이 챕터의 질문은 두 개다.
...
> 내 코드: [`memory/JavaMemoryMain1.java`](../../java-basic/src/memory/JavaMemoryMain1.java)
...
> 내 코드: [`memory/JavaMemoryMain2.java`](../../java-basic/src/memory/JavaMemoryMain2.java),
> [`memory/Data.java`](../../java-basic/src/memory/Data.java)
...
> 내 코드: [`static1`](../../java-basic/src/static1) 패키지
...
> 내 코드: [`static2/DecoUtil1.java`](../../java-basic/src/static2/DecoUtil1.java),
> [`static2/DecoUtil2.java`](../../java-basic/src/static2/DecoUtil2.java)
...
> 내 코드: [`static2/DecoData.java`](../../java-basic/src/static2/DecoData.java)
